...
public class AttackAction implements EntityAction {
    ...
    private EntityAINearestAttackableTarget test12;
        ...
        test3 = new EntityAIAttackOnCollide((EntityCreature) robot, EntityPlayer.class, 1.0D, false);
        test4 = new EntityAIAttackOnCollide((EntityCreature) robot, EntityVillager.class, 1.0D, true);
        test5 = new EntityAIMoveTowardsRestriction((EntityCreature) robot, 1.0D);
        test6 = new EntityAIMoveThroughVillage((EntityCreature) robot, 1.0D, false);
        ...
        test11 = new EntityAINearestAttackableTarget((EntityCreature) robot, EntityPlayer.class, 0, true);
        test12 = new EntityAINearestAttackableTarget((EntityCreature) robot, EntityVillager.class, 0, false);
